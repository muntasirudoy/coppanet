...
import logo from "../assets/images/icons/footer5-logo.svg";
              ...
              <div className="col-lg-3 col-md-6 d-flex justify-content-lg-center">
                <div className="footer-item">
                  ...
                  <ul className="footer-list">
                    ...
                    <li>
                      <a href="service.html">Web Solution</a>
                    </li>
                    <li>
                      <a href="service.html">Digital Merketing</a>
                    </li>
                    <li>
                      <a href="service.html">App Design</a>
                    </li>
                    <li>
                ...
                <div className="footer-item">
                  ...
                  <ul className="address-list">
                    ...
                    <li>
                      ...
                      <a href="tel:+8801761456456">+8801761456456</a>
                    </li>
                    <li>
                      <svg
                        width="18"
                      ...
                      <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#523b3c343d12372a333f223e377c313d3f">
                        <span
